...
document.querySelectorAll('iframe').forEach(function (iframe) {
  ...
  if (src.includes('youtu') || src.includes('vimeo')) {
    var parent = iframe.parentElement; // If already wrapped correctly, skip

    if (parent.classList.contains('video-wrapper')) return; // Create new wrapper

    var wrapper = document.createElement('div');
    wrapper.classList.add('video-wrapper'); // Replace <p> (or any parent) with wrapper

    parent.parentNode.insertBefore(wrapper, parent); // Move iframe into wrapper

    wrapper.appendChild(iframe); // Remove old parent if it's just a container (like <p>)
...
/* harmony import */ var _js_global_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../js/global.js */ "./js/global.js");
/* harmony import */ var _js_global_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_js_global_js__WEBPACK_IMPORTED_MODULE_0__);
// src/app.js
...
/******/ 	__webpack_require__.O(undefined, ["dist/style"], () => (__webpack_require__("./src/app.js")))
