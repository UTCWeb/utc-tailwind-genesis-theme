...
(function ($) {
	...
	$(
		'<i class="fa fa-share-alt-square utc-share" title="Share this article."></i>',
	).appendTo('a.addtoany_share');
	...
	$('.sidebar .widget_nav_menu .widget-wrap').each(function () {
		if (!($(this).find('h3').length > 0)) {
			$('<h3 class="widgettitle widget-title">Section Menu</h3>').prependTo(
				this,
			);
		}
	});
	...
	const bodyHasFirstParagraphTrue = document.body.classList.contains(
